    ...
    return <div style={{margin: '16px'}}>
        <div style={{
            ...
            <div style={{
                ...
                <div style={{}}>
                    <Typography color={theme.palette.text.secondary}>Изменен {changed}</Typography>
                    <Typography variant={'h6'}>{header}</Typography>
                </div>
                <div style={{display: 'flex', color: theme.palette.text.secondary}}>
                    <EditOutlinedIcon style={{marginRight: '16px', cursor: 'pointer'}}/>
                    <DeleteOutlineIcon style={{cursor: 'pointer'}}/>
                </div>
            </div>
            <div>
                <div style={{padding: '100px 200px'}}>
                    <InsertDriveFileIcon color={'error'} style={{height: '100px', width: '100px'}}/>
                </div>
            </div>
...
export const Documents = () => {
    ...
    >
        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', marginLeft: '-12px'}}>
